...
, function(e, t, n) {
    ...
    var i = n(3)
      ...
      , s = function() {
        function e(e) {
            this.config = e,
            i.isHttps() ? this.domainList = e.cdnList.filter(function(e) {
                return "http:" !== e.substr(0, 5)
            }) : this.domainList = e.cdnList,
            this.timeout = e.timeout >= 0 ? e.timeout : 0,
            this.totalRetry = e.totalRetry >= 0 ? e.totalRetry : 5,
            this.promiseMap = {},
            this.retryMap = {},
            this.indexMap = {},
            this.index = 0
                ...
                return o(this, function(n) {
                    ...
                    case 0:
                        if (this.config.debug)
                            return [2, ""];
                        void 0 === (t = this.promiseMap[e]) && (this.retryMap[e] = 0,
                        this.indexMap[e] = this.index,
                        t = this.loadAndRetry(e, this.index),
        ...
        ,
        e.prototype.loadAndRetry = function(e, t) {
            return void 0 === t && (t = 0),
            r(this, void 0, void 0, function() {
                ...
                return o(this, function(o) {
                    switch (o.label) {
                    case 0:
                        n = (this.retryMap[e] === this.totalRetry || t >= this.domainList.length ? "./" : this.domainList[t]) + e,
                        this.retryMap[e]++,
                        o.label = 1;
                    case 1:
                        return o.trys.push([1, 3, , 7]),
                        [4, u.default({
                            url: n,
                    ...
                    case 3:
                        return r = o.sent(),
                        this.retryMap[e] <= this.totalRetry ? (this.indexMap[e] = this.nextIndex(this.indexMap[e]),
                        [4, this.loadAndRetry(e, this.indexMap[e])]) : [3, 5];
                    case 4:
                        return [2, o.sent()];
                    case 5:
                        throw r;
        ...
        ,
        e.prototype.nextIndex = function(e) {
            return this.domainList.length > 0 ? (e + 1) % this.domainList.length : 0
        }
        ,
        e
    }();
...
, function(e, t, n) {
    ...
    e.exports = function(e) {
        return new Promise(function(t, f) {
            ...
            ,
            d.onerror = function() {
                f(a("Network Error", e, null, d)),
                d = null
            }
            ,
            d.ontimeout = function() {
                f(a("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", d)),
                d = null
            }
            ,
...
, function(e, t, n) {
    ...
    var i = n(2)
      , u = function() {
        function e(e) {
            this.config = e,
            this.fileLoader = new i.FileLoader(e),
            this.evalPromMap = {}
        }
        return e.prototype.getModuleConfig = function() {
        ...
        e.prototype.load = function(e, t) {
            ...
            r(this, void 0, void 0, function() {
                ...
                return o(this, function(o) {
                    switch (o.label) {
                    case 0:
                        return void 0 === (n = this.evalPromMap[e]) && (n = this.loadAndEval(e, t),
                        this.evalPromMap[e] = n),
                        [4, n];
                    case 1:
                        return o.sent(),
                        (r = window[e]) ? (i = r.moduleHandler) && i.prepare ? [4, i.prepare(t)] : [3, 3] : [2, void 0];
                    case 2:
                        return [2, o.sent()];
                    case 3:
                        return [2, void 0]
        ...
        ,
        e.prototype.loadAndEval = function(e, t) {
            return r(this, void 0, void 0, function() {
                var n, r, i, u, s = this;
                return o(this, function(o) {
                    switch (o.label) {
                    case 0:
                        return n = this.getModuleInfoByName(e),
                        r = n.dependencies.map(function(e) {
                            return s.load(e, t)
                        }, this),
                        i = this.fileLoader.load(n.file),
                        [4, Promise.all(r)];
                    case 1:
                        return o.sent(),
                        [4, i];
        ...
        ,
        e.prototype.getModuleInfoByName = function(e) {
            return this.config.modules.filter(function(t) {
                return t.name === e
            })[0]
        }
        ,
...
, function(e, t, n) {
    ...
    e.exports = function(e) {
        for (var t, n, i = String(e), u = "", s = 0, a = r; i.charAt(0 | s) || (a = "=",
        s % 1); u += a.charAt(63 & t >> 8 - s % 1 * 8)) {
...
, function(e, t, n) {
    ...
    window.setupCubeLoader = function(e, t, n, s) {
        return void 0 === e && (e = []),
        void 0 === t && (t = 0),
        void 0 === n && (n = 5),
        void 0 === s && (s = !1),
        r(this, void 0, void 0, function() {
            ...
            return o(this, function(o) {
                switch (o.label) {
                case 0:
                    return [4, i.default("./module.config.json?t=" + Date.now())];
                case 1:
                    return r = o.sent(),
                    a = r.data.modules,
                    [2, new u.ModuleLoader({
                        cdnList: e,
                        timeout: t,
                        totalRetry: n,
                        debug: s,
