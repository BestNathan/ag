...
!function(e) {
    var t = function(t) {
        ...
        r.prototype.getRequest = function() {
            ...
            return e || (e = new egret.HttpRequest,
            e.addEventListener(egret.Event.COMPLETE, this.onLoadFinish, this),
            e.addEventListener(egret.IOErrorEvent.IO_ERROR, this.onLoadFinish, this)),
        ...
        ,
        r.prototype.destroyRes = function(e) {
            return this.fileDic[e] ? (this.onResourceDestroy(this.fileDic[e]),
...
!function(e) {
    var t = function(t) {
        ...
        r.prototype.destroyRes = function(e) {
            ...
            if (t) {
                ...
                for (var i in t._textureMap)
                    null == r && (r = t._textureMap[i],
                    this.onResourceDestroy(r),
                    r = null),
        ...
        r.prototype.getImageLoader = function() {
            ...
            return e || (e = new egret.ImageLoader,
            e.addEventListener(egret.Event.COMPLETE, this.onLoadFinish, this),
            e.addEventListener(egret.IOErrorEvent.IO_ERROR, this.onLoadFinish, this)),
            e
        }
...
!function(e) {
    var t = function(t) {
        ...
        r.prototype.getOneResourceItem = function() {
            ...
            for (var i, n = r.length, o = 0; n > o && (this.queueIndex >= n && (this.queueIndex = 0),
        ...
        r.prototype.onItemComplete = function(t) {
            ...
            if (!t.loaded) {
                ...
                if (!(i > this.maxRetryTimes))
                    return this.retryTimesDic[t.name] = i + 1,
            ...
            if (r) {
                ...
                if (t.loaded || (this.groupErrorDic[r] = !0),
                e.ResourceEvent.dispatchResourceEvent(this.resInstance, e.ResourceEvent.GROUP_PROGRESS, r, t, n, o),
                n == o) {
...
!function(e) {
    var t = function(e) {
        ...
        t.prototype.analyzeConfig = function(e, t) {
            ...
            return r ? n = this.getRelativePath(e.url, r.file) : (r = t,
            n = this.getTexturePath(e.url, r)),
            this.sheetMap[i] = r,
            n
        }
        ,
...
!function(e) {
    var t = function() {
        ...
        t.prototype.createGroup = function(e, t, r) {
            ...
            return 0 == n.length ? !1 : (this.groupDic[e] = n,
            !0)
        }
        ,
        ...
        t.prototype.addItemToKeyMap = function(e) {
            if (this.keyMap[e.name] || (this.keyMap[e.name] = e),
    ...
    !function(t) {
        var r = function() {
            ...
            return e.prototype.fetchVersion = function(e) {
                var t = this;
                if (t._versionPath = "all.manifest",
            ...
            e.prototype.getLocalData = function(e) {
                if (egret_native.readUpdateFileSync && egret_native.readResourceFileSync) {
                    ...
                    if (null != t)
                        return JSON.parse(t);
                    if (t = egret_native.readResourceFileSync(e),
                    null != t)
                        return JSON.parse(t)
                }
                return null
...
!function(e) {
    var t = function(t) {
        ...
        ,
        r.prototype.destroyRes = function(e) {
            return this.soundDic[e] ? (delete this.soundDic[e],
            !0) : !1
        }
        ,
        r
    ...
    var _ = function(t) {
        ...
        r.prototype.onGroupComp = function(t) {
            if (t.groupName == r.GROUP_CONFIG) {
                ...
                this.loadedGroups.push(t.groupName),
        ...
        r.prototype.onGroupError = function(t) {
            t.groupName == r.GROUP_CONFIG ? (this.loadingConfigList = null,
            e.ResourceEvent.dispatchResourceEvent(this, e.ResourceEvent.CONFIG_LOAD_ERROR)) : this.dispatchEvent(t)
        }
        ,
        ...
        r.prototype.getResAsync = function(t, r, i) {
            ...
            if ("" == n && (o = e.AnalyzerBase.getStringPrefix(t),
...
!function(e) {
    var t = function(t) {
        ...
        r.prototype.destroyRes = function(e) {
            var t = this.fileDic[e];
            return t ? (delete this.fileDic[e],
            !0) : !1
        }
        ,
        r.prototype.loadImage = function(t, r) {
