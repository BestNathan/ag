...
class CryptoBroadcastKeyResp extends ResponseBase {
    ...
    decodeData() {
        this.decryptKey = this.data.slice(this.offset, this.offset + 4).readInt32LE();
        this.offset += 4;
    }
}
...
class CryptoUserKeyResp extends ResponseBase {
    ...
    decodeData() {
        ...
        this.offset += 1;
        this.cryptoKey = this.data.slice(this.offset, this.offset + 4).readInt32LE();
        this.offset += 4;
    }
}
...
class CryptoUserResp extends ResponseBase {
    ...
    decodeData(key) {
        ...
        this.encData = asm.Decrypt(this.data, key);
